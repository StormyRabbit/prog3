...
jumpyboy::FlyingEnemy *jumpyboy::EnemyFactory::fly(int x, int y, int w, int h, int maxX, int minX, int speed) {
    ...
    movingVariables.insert(std::pair<std::string, double>("minX", minX));
